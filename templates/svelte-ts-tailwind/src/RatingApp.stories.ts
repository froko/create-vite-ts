...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    expect(overallSatisfaction2.firstElementChild).not.toHaveClass('text-orange-500');
    ...
    expect(overallSatisfaction5.firstElementChild).not.toHaveClass('text-orange-500');
  }
};
